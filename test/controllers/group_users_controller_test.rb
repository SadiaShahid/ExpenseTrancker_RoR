...
class GroupUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_user" do
    assert_difference('GroupUser.count') do
      post group_users_url, params: { group_user: { g_id: @group_user.g_id, role: @group_user.role, u_id: @group_user.u_id } }
    end
  ...
  test "should update group_user" do
    patch group_user_url(@group_user), params: { group_user: { g_id: @group_user.g_id, role: @group_user.role, u_id: @group_user.u_id } }
