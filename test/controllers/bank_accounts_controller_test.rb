...
class BankAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post bank_accounts_url, params: { bank_account: { acc_no: @bank_account.acc_no, balance: @bank_account.balance, bank_name: @bank_account.bank_name } }
    end
  ...
  test "should update bank_account" do
    patch bank_account_url(@bank_account), params: { bank_account: { acc_no: @bank_account.acc_no, balance: @bank_account.balance, bank_name: @bank_account.bank_name } }
