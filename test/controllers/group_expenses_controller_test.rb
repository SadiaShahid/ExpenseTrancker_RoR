...
class GroupExpensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_expense" do
    assert_difference('GroupExpense.count') do
      post group_expenses_url, params: { group_expense: { amount: @group_expense.amount, name: @group_expense.name } }
    end
  ...
  test "should update group_expense" do
    patch group_expense_url(@group_expense), params: { group_expense: { amount: @group_expense.amount, name: @group_expense.name } }
